...
if __name__ == "__main__":
    print("=" * 70)
    print("PREGUNTA 1: Â¿Importa la forma de salir de crisis?")
    print("=" * 70)
    ...
    print()
    print("=" * 70)
    print("PREGUNTA 2: Â¿MÃºltiples crisis vs una larga?")
    print("=" * 70)
    ...
    print_result(r4, f"DaÃ±o: {r4['damage']:.3f}")
    print_result(r5, f"DaÃ±o: {r5['damage']:.3f}")
    print_result(r6, f"DaÃ±o: {r6['damage']:.3f}")
    
    print()
    print("=" * 70)
    print("PREGUNTA 3: Â¿Importa el orden restore/enhance?")
    print("=" * 70)
    ...
    print()
    print("=" * 70)
    print("PREGUNTA 4: Â¿Hay crisis toxicas que solo destruyen?")
    print("=" * 70)
